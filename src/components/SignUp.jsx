        ...
        <div className="container">
            ...
            <form className="form" action="#" onSubmit={getUser}>
                <div className="form_name">
                    <input className="form_input_sm" style={{borderColor: name === "" ? "grey" : name.match(nameValidator) ? "green" : "red"}}  type="text" placeholder="First Name *" value={name} onChange={(e)=>{setName(e.target.value)}} required/>
                    <input className="form_input_sm" style={{borderColor: lastname === "" ? "grey" : lastname.match(nameValidator) ? "green" : "red"}}  type="text" placeholder="Last Name *" value={lastname} onChange={(e)=>{setLastname(e.target.value)}} required/>
                </div>
                <input className="form_input" style={{borderColor: email === "" ? "grey" : email.match(mailValidator) ? "green" : "red"}}  type="email" placeholder="Email Address *" value={email} onChange={(e)=>{setEmail(e.target.value)}} required/>
                <input className="form_input" style={{borderColor: password === "" ? "grey" : password.match(passwordValidator) ? "green" : "red"}}  type="password" placeholder="Password *" value={password} onChange={(e)=>{setPassword(e.target.value)}} required/>
